  ...
  return (
    <div className="min-h-screen p-4 md:p-8 flex flex-col font-sans">
      ...
      <header className="mb-6 relative">
        ...
        <a
          href="/"
          className="absolute left-0 top-0 flex items-center gap-2 px-3 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-lg transition-colors shadow-lg hover:shadow-blue-600/50"
          title="Back to Main Manager"
        >
          <Home size={18} />
        ...
        <div className="text-center">
          <h1 className="text-3xl font-bold text-white tracking-tight">WOS Rank Manager</h1>
          <p className="text-blue-200 text-sm mt-1">Alliance Rank Management System</p>
          <div className="mt-2 flex items-center justify-center gap-4">
            <span className="text-teal-400 text-sm">Members: {totalOnline}</span>
            {players.length > 0 && (
              <button
                onClick={handleClearAll}
                className="px-3 py-1 bg-red-600/80 hover:bg-red-500 text-white text-xs rounded-lg transition-colors flex items-center gap-1"
